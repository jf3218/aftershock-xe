...
void G_WriteXMLStats( void ){
	...
	writeToFile(va("<match datetime=\"%i/%02i/%02i %02i:%02i:%02i\" map=\"%s\" type=\"%s\" isTeamGame=\"%s\" instagib=\"%s\" rocketsOnly=\"%s\" >\n\n", 
		       ...
		       boolToChar(g_instantgib.integer == 1), boolToChar(g_rockets.integer == 1)), &f);
