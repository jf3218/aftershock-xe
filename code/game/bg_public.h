...
#define EF_AWARD_AIRROCKET	0x00100000		// draw a airrocket sprite
#define EF_AWARD_AIRGRENADE	0x00100000		// draw a airgrenade sprite
...
typedef enum {
	...
	EV_ITEM_POP,
	EV_PROJECTILE_TELEPORT_IN,
	EV_PROJECTILE_TELEPORT_OUT,
...
qboolean	BG_PlayerTouchesItem( playerState_t *ps, entityState_t *item, int atTime, int newItemHeight );
