...
void G_Knockback( gentity_t *targ, gentity_t *inflictor, gentity_t *attacker, vec3_t dir, vec3_t point, int damage );
qboolean G_RadiusDamage (vec3_t origin, gentity_t *attacker, float damage, float radius, gentity_t *ignore, int mod);
void G_RadiusKnockback ( vec3_t origin, gentity_t *attacker, float damage, float radius, gentity_t *ignore);
