...
void G_SendEliminationStats( void ) {
	...
	trap_SendServerCommand( -1, va( "print \"Max dmg done  : ^2%3i ^7%s\"", g_clients[maxdmgdoneClientnum].elimRoundDamage, g_clients[maxdmgdoneClientnum].pers.netname ) );
	trap_SendServerCommand( -1, va( "print \"Min dmg taken : ^1%3i ^7%s\"", g_clients[mindmgtakenClientnum].elimRoundDamageTaken, g_clients[mindmgtakenClientnum].pers.netname ) );
	trap_SendServerCommand( -1, va( "print \"Max no. frags : ^3%3i ^7%s\"", g_clients[maxkillsClientnum].elimRoundKills, g_clients[maxkillsClientnum].pers.netname ) );
