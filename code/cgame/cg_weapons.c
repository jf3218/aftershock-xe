...
void CG_RegisterWeapon( int weaponNum ) {
	...
	case WP_GAUNTLET:
		...
		weaponInfo->firingSound = CG_RegisterSoundOption( "sound/weapons/melee/fstrun.wav", qfalse );
		weaponInfo->flashSound[0] = CG_RegisterSoundOption( "sound/weapons/melee/fstatck.wav", qfalse );
		break;

	case WP_LIGHTNING:
		MAKERGB( weaponInfo->flashDlightColor, 0.6f, 0.6f, 1.0f );
		weaponInfo->readySound = CG_RegisterSoundOption( "sound/weapons/melee/fsthum.wav", qfalse );
		weaponInfo->firingSound = CG_RegisterSoundOption( "sound/weapons/lightning/lg_hum.wav", qfalse );

		weaponInfo->flashSound[0] = CG_RegisterSoundOption( "sound/weapons/lightning/lg_fire.wav", qfalse );
		...
		cgs.media.sfx_lghit1 = CG_RegisterSoundOption( "sound/weapons/lightning/lg_hit.wav", qfalse );
		cgs.media.sfx_lghit2 = CG_RegisterSoundOption( "sound/weapons/lightning/lg_hit2.wav", qfalse );
		cgs.media.sfx_lghit3 = CG_RegisterSoundOption( "sound/weapons/lightning/lg_hit3.wav", qfalse );
...
#ifdef MISSIONPACK
	case WP_CHAINGUN:
		weaponInfo->firingSound = CG_RegisterSoundOption( "sound/weapons/vulcan/wvulfire.wav", qfalse );
		weaponInfo->loopFireSound = qtrue;
		MAKERGB( weaponInfo->flashDlightColor, 1, 1, 0 );
		weaponInfo->flashSound[0] = CG_RegisterSoundOption( "sound/weapons/vulcan/vulcanf1b.wav", qfalse );
		weaponInfo->flashSound[1] = CG_RegisterSoundOption( "sound/weapons/vulcan/vulcanf2b.wav", qfalse );
		weaponInfo->flashSound[2] = CG_RegisterSoundOption( "sound/weapons/vulcan/vulcanf3b.wav", qfalse );
		weaponInfo->flashSound[3] = CG_RegisterSoundOption( "sound/weapons/vulcan/vulcanf4b.wav", qfalse );
	...
	case WP_MACHINEGUN:
		MAKERGB( weaponInfo->flashDlightColor, 1, 1, 0 );
		weaponInfo->flashSound[0] = CG_RegisterSoundOption( "sound/weapons/machinegun/machgf1b.wav", qfalse );
		weaponInfo->flashSound[1] = CG_RegisterSoundOption( "sound/weapons/machinegun/machgf2b.wav", qfalse );
		weaponInfo->flashSound[2] = CG_RegisterSoundOption( "sound/weapons/machinegun/machgf3b.wav", qfalse );
		weaponInfo->flashSound[3] = CG_RegisterSoundOption( "sound/weapons/machinegun/machgf4b.wav", qfalse );
		weaponInfo->ejectBrassFunc = CG_MachineGunEjectBrass;
		if( cg_nomip.integer & 16 )
			cgs.media.bulletExplosionShader = trap_R_RegisterShader( "aftershock_bulletExplosion_nomip" );
		else
	...
	case WP_SHOTGUN:
		MAKERGB( weaponInfo->flashDlightColor, 1, 1, 0 );
		weaponInfo->flashSound[0] = CG_RegisterSoundOption( "sound/weapons/shotgun/sshotf1b.wav", qfalse );
		weaponInfo->ejectBrassFunc = CG_ShotgunEjectBrass;
		break;

	case WP_ROCKET_LAUNCHER:
		weaponInfo->missileModel = trap_R_RegisterModel( "models/ammo/rocket/rocket.md3" );
		weaponInfo->missileSound = CG_RegisterSoundOption( "sound/weapons/rocket/rockfly.wav", qfalse );
		...
		weaponInfo->flashSound[0] = CG_RegisterSoundOption( "sound/weapons/rocket/rocklf1a.wav", qfalse );
	...
	case WP_PROX_LAUNCHER:
		...
		weaponInfo->flashSound[0] = CG_RegisterSoundOption( "sound/weapons/proxmine/wstbfire.wav", qfalse );
	...
	case WP_GRENADE_LAUNCHER:
		...
		weaponInfo->trailRadius = 32;
		MAKERGB( weaponInfo->flashDlightColor, 1, 0.70f, 0 );
		weaponInfo->flashSound[0] = CG_RegisterSoundOption( "sound/weapons/grenade/grenlf1a.wav", qfalse );
...
//		weaponInfo->missileSound = CG_RegisterSoundOption( "sound/weapons/nailgun/wnalflit.wav", qfalse );
		weaponInfo->trailRadius = 16;
		weaponInfo->wiTrailTime = 250;
		weaponInfo->missileModel = trap_R_RegisterModel( "models/weaphits/nail.md3" );
		MAKERGB( weaponInfo->flashDlightColor, 1, 0.75f, 0 );
		weaponInfo->flashSound[0] = CG_RegisterSoundOption( "sound/weapons/nailgun/wnalfire.wav", qfalse );
		break;
#endif
...
//		weaponInfo->missileModel = cgs.media.invulnerabilityPowerupModel;
		...
		weaponInfo->missileSound = CG_RegisterSoundOption( "sound/weapons/plasma/lasfly.wav", qfalse );
		weaponInfo->missileDlight = 75;
		
		MAKERGB( weaponInfo->flashDlightColor, 0.6f, 0.6f, 1.0f );
		MAKERGB( weaponInfo->missileDlightColor, 0.6f, 0.6f, 1.0f );
		
		weaponInfo->flashSound[0] = CG_RegisterSoundOption( "sound/weapons/plasma/hyprbf1a.wav", qfalse );
	...
	case WP_RAILGUN:
		weaponInfo->readySound = CG_RegisterSoundOption( "sound/weapons/railgun/rg_hum.wav", qfalse );
		MAKERGB( weaponInfo->flashDlightColor, 1, 0.5f, 0 );
		weaponInfo->flashSound[0] = CG_RegisterSoundOption( "sound/weapons/railgun/railgf1a.wav", qfalse );
	...
	case WP_BFG:
		weaponInfo->readySound = CG_RegisterSoundOption( "sound/weapons/bfg/bfg_hum.wav", qfalse );
		MAKERGB( weaponInfo->flashDlightColor, 1, 0.7f, 1 );
		weaponInfo->flashSound[0] = CG_RegisterSoundOption( "sound/weapons/bfg/bfg_fire.wav", qfalse );
...
static float	CG_MachinegunSpinAngle( centity_t *cent ) {
	...
	if ( cent->pe.barrelSpinning == !(cent->currentState.eFlags & EF_FIRING) ) {
		...
		if ( cent->currentState.weapon == WP_CHAINGUN && !cent->pe.barrelSpinning ) {
			trap_S_StartSound( NULL, cent->currentState.number, CHAN_WEAPON, CG_RegisterSoundOption( "sound/weapons/vulcan/wvulwind.wav", qfalse ) );
		}
#endif
	}
